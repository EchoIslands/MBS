...
export const mockShops: Shop[] = [
  {
    ...
    employees: [
      ...
      { id: 'ceo1', name: '陈总', phone: '1390000100', avatar: '', title: 'CEO/老板', rating: 5.0, isActive: true, specialty: '店铺管理', role: UserRole.CEO },
      { id: 'cs1', name: '刘客服', phone: '1390000101', avatar: '', title: '客服专员', rating: 4.8, isActive: true, specialty: '客户回访/维护', role: UserRole.CUSTOMER_SERVICE },
      { id: 'mgr1', name: '张店长', phone: '1390000102', avatar: '', title: '店长', rating: 4.7, isActive: true, specialty: '店铺运营', role: UserRole.SHOP_MANAGER },
    ],
