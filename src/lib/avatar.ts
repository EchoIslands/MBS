// 本地生成头像 SVG，避免依赖外部 API（dicebear 在国内被墙）
...
export function getAvatarUrl(name: string): string {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 80 80">
    ...
    <text x="40" y="52" text-anchor="middle" fill="white" font-size="32" font-family="Arial, sans-serif" font-weight="bold">${initials}</text>
  </svg>`;
